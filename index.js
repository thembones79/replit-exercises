...
console.log(arrSum([9, 1, 22, 0, 2])); // will output 34
...
console.log(commonElements(["b", 3, 4, 76, "c"], ["a", "b", 4, 76, 21, "e"])); // will output ['b', 4, 76]
...
console.log(compareObjects({ a: "b", c: "d" }, { c: "d", a: "b" })); /// will output true
console.log(compareObjects({ a: "c", c: "a" }, { c: "d", a: "b", q: "s" })); /// will output false
...
function filterObject(arr, obj) {
  return Object.fromEntries(
    Object.entries(obj).filter(([key, val]) => !arr.includes(key))
  );
}
console.log(
  filterObject(["color", "size"], { color: "Blue", id: "22", size: "xl" }) // will output { id: '22' }
);
